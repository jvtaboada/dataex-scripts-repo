...
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Cluster_Node_Status]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Cluster_Node_Status
GO

CREATE PROCEDURE [dbo].dtx_sp_Alert_Cluster_Node_Status 
AS
BEGIN
	SET NOCOUNT ON
