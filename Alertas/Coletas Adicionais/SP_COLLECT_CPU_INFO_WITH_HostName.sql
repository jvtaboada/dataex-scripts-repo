USE [DBADataEX]
GO
/****** Object:  StoredProcedure [dbo].[Sp_Collect_CPU_Info]    Script Date: 5/16/2022 11:25:49 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create or ALTER PROCEDURE [dbo].[Sp_Collect_CPU_Info] @Environment NVARCHAR(15)
--WITH ENCRYPTION
as
...
--
INSERT INTO @cpuInfo (VirtualMachineType, NUMA_Config, NUMA_Nodes, Logical_CPUs, CPU_AffinityType, MAXDOP_Current, ParallelCostThreshold_Current,HostName)
VALUES (
...
--DECLARE @ServerNameTMP TABLE (SeverName sql_Variant)
--INSERT INTO @cpuInfo (HostName) 
--	VALUES (
--	(Select SERVERPROPERTY('MachineName'))
--			)
--select * from @cpuInfo

INSERT INTO DBADataEx.dbo.CPUINFO
SELECT	GETDATE(),
		VirtualMachineType, 
		NUMA_Config, 
		NUMA_Nodes, 
		...
		CPU_Cores, 
		Logical_CPUs, 
		Logical_CPUs_per_NUMA, 
		CPU_AffinityType,
		ParallelCostThreshold_Current, 
		MAXDOP_Current, 
		MAXDOP_Optimal_Value, 
		MAXDOP_Optimal_Reason,
		@Environment,
		CAST (HostName AS nvarchar(20))
FROM @cpuInfo

--EXEC Sp_Collect_CPU_Info PROD
--SELECT * FROM DBADataEx.dbo.CPUINFO