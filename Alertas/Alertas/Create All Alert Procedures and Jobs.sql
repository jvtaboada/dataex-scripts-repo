...
SET NOCOUNT ON
	...
	IF ( OBJECT_ID('[dbo].[dtx_tb_HTML_Parameter]') IS NOT NULL )
		DROP TABLE [dbo].dtx_tb_HTML_Parameter

	CREATE TABLE dtx_tb_HTML_Parameter (
		Company_Link VARCHAR(4000),
		Line_Space VARCHAR(4000),
		Header VARCHAR(4000))

	INSERT INTO dtx_tb_HTML_Parameter(Company_Link,Line_Space,Header)
	SELECT '<br />
			<br />'			
			+ 
				'<a href="https://www.dataex.com.br" target=”_blank”> 
					<img	src="https://www.dataex.com.br/wp-content/uploads/2019/07/Logo-Laranja-e-Cinza.png"
...
GO
IF ( OBJECT_ID('dbo.dtx_sp_Send_Dbmail') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Send_Dbmail
GO

	CREATE PROCEDURE dtx_sp_Send_Dbmail @Ds_Profile_Email VARCHAR(200), @Ds_Email VARCHAR(500),@Ds_Subject VARCHAR(500),@Ds_Mail_HTML VARCHAR(MAX),@Ds_BodyFormat VARCHAR(50),@Ds_Importance VARCHAR(50)
			AS					
...
IF ( OBJECT_ID('[dbo].[dtx_sp_Export_Table_HTML_Output]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Export_Table_HTML_Output
GO

CREATE PROCEDURE [dbo].[dtx_sp_Export_Table_HTML_Output]
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Read_Error_log]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Read_Error_log
GO
CREATE PROCEDURE dtx_sp_Read_Error_log @Actual_Log bit
AS
BEGIN
	SET DATEFORMAT YMD
	...
	END 
		ELSE --@Actual_Log = 1 - most recent 
        	BEGIN 
				...
				SELECT @Vl_Parameter_2 = Vl_Parameter_2 FROM [dtx_tb_Alert_Parameter] 	WHERE [Nm_Alert] = 'Slow Disk Every Hour'
...
IF ( OBJECT_ID('[dbo].[dtx_sp_WhoIsActive_Result]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_WhoIsActive_Result
	GO
	
	
CREATE PROCEDURE [dbo].[dtx_sp_WhoIsActive_Result]
AS
BEGIN
...
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Index_Fragmentation') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Index_Fragmentation
GO
	

CREATE PROCEDURE [dbo].dtx_sp_Alert_Index_Fragmentation 
AS
BEGIN
	SET NOCOUNT ON
	...
	from dtx_vw_Index_Fragmentation_History
...
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Cluster_Active_Node]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Cluster_Active_Node
GO

CREATE PROCEDURE [dbo].dtx_sp_Alert_Cluster_Active_Node 
AS
BEGIN
	SET NOCOUNT ON
	...
	SELECT @Table_Active_Node = Nm_Active_server FROM dtx_tb_Alert_Cluster_Active_Node 
	...
	BEGIN	
			...
			UPDATE dtx_tb_Alert_Cluster_Active_Node
...
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_CPU_Utilization_MI]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_CPU_Utilization_MI
GO

--[dbo].[dtx_sp_WhoIsActive_Result]
CREATE PROCEDURE [dbo].[dtx_sp_Alert_CPU_Utilization_MI]
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_MaxSize_Growth]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_MaxSize_Growth
GO
--[dbo].[dtx_sp_WhoIsActive_Result]
CREATE PROCEDURE [dbo].dtx_sp_Alert_MaxSize_Growth 
AS
BEGIN
	SET NOCOUNT ON
...
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Database_Growth') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Database_Growth
GO
USE [DBADataex]
GO
/****** Object:  StoredProcedure [dbo].[dtx_sp_Alert_Database_Growth]    Script Date: 08/08/2019 08:04:43 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE [dbo].[dtx_sp_Alert_Database_Growth]
AS
BEGIN
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_CPU_Utilization]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].[dtx_sp_Alert_CPU_Utilization]
GO

CREATE PROCEDURE [dbo].[dtx_sp_Alert_CPU_Utilization]
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Blocked_Process]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Blocked_Process
GO
USE [DBADataex]
GO
/****** Object:  StoredProcedure [dbo].[dtx_sp_Alert_Blocked_Process]    Script Date: 7/29/2019 5:01:50 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE PROCEDURE [dbo].[dtx_sp_Alert_Blocked_Process] @Nm_Alert varchar(50)
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Database_Status]') IS NOT NULL )
	DROP PROCEDURE [dbo].dtx_sp_Alert_Database_Status
GO
CREATE PROCEDURE [dbo].[dtx_sp_Alert_Database_Status] 
AS
BEGIN
	SET NOCOUNT ON
...
*******************************************************************************************************************************/
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Database_Without_Log_Backup') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Database_Without_Log_Backup
GO
CREATE PROCEDURE [dbo].dtx_sp_Alert_Database_Without_Log_Backup
AS
BEGIN
	SET NOCOUNT ON
...
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Disk_Space]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Disk_Space
GO

GO
CREATE PROCEDURE [dbo].[dtx_sp_Alert_Disk_Space]
AS
BEGIN
...
GO
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_IO_Pending') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_IO_Pending
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
CREATE PROCEDURE [dbo].[dtx_sp_Alert_IO_Pending]
AS
BEGIN
	SET NOCOUNT ON
	...
	insert into dtx_tb_Log_IO_Pending([Nm_Database], [Physical_Name], [IO_Pending], [IO_Pending_ms], [IO_Type], [Number_Reads], [Number_Writes], [Dt_Log])
...
GO
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Large_LDF_File') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Large_LDF_File
GO
CREATE PROCEDURE [dbo].dtx_sp_Alert_Large_LDF_File
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Log_Full]') IS NOT NULL )
	DROP PROCEDURE [dbo].dtx_sp_Alert_Log_Full
GO
CREATE PROCEDURE [dbo].[dtx_sp_Alert_Log_Full] 
AS
BEGIN
	SET NOCOUNT ON
...
GO
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Memory_Available') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Memory_Available
GO
CREATE PROCEDURE [dbo].dtx_sp_Alert_Memory_Available
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Page_Corruption]') IS NOT NULL )
	DROP PROCEDURE [dbo].dtx_sp_Alert_Page_Corruption
GO
CREATE PROCEDURE [dbo].dtx_sp_Alert_Page_Corruption 
AS
BEGIN
	SET NOCOUNT ON
...
GO
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Slow_Disk') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Slow_Disk
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
--Chamar essa antes
--EXEC dtx_sp_Read_Error_log 1 --@Actual_Log = 1 - most recent 
-- dtx_sp_Alert_Slow_Disk 'Slow Disk Every Hour'
-- dtx_sp_Alert_Slow_Disk 'Slow Disk'

CREATE PROCEDURE [dbo].dtx_sp_Alert_Slow_Disk @Nm_Alert VARCHAR(100)
AS
BEGIN
	SET NOCOUNT ON
...
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_SQLServer_Connection') IS NOT NULL )
	DROP PROCEDURE [dbo].dtx_sp_Alert_SQLServer_Connection
GO
...
CREATE PROCEDURE [dbo].dtx_sp_Alert_SQLServer_Connection
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_SQLServer_Restarted]') IS NOT NULL )
	DROP PROCEDURE [dbo].dtx_sp_Alert_SQLServer_Restarted
GO
CREATE PROCEDURE [dbo].dtx_sp_Alert_SQLServer_Restarted 
AS
BEGIN
...
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Tempdb_MDF_File_Utilization]') IS NOT NULL )
	DROP PROCEDURE [dbo].dtx_sp_Alert_Tempdb_MDF_File_Utilization
GO
...
CREATE PROCEDURE [dbo].dtx_sp_Alert_Tempdb_MDF_File_Utilization
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Database_Created]') IS NOT NULL )
	DROP PROCEDURE [dbo].dtx_sp_Alert_Database_Created
GO

CREATE PROCEDURE [dbo].dtx_sp_Alert_Database_Created
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Database_Without_Backup]') IS NOT NULL )
	DROP PROCEDURE [dbo].dtx_sp_Alert_Database_Without_Backup
GO
CREATE PROCEDURE [dbo].dtx_sp_Alert_Database_Without_Backup 
AS
BEGIN
	SET NOCOUNT ON
	...
	FROM [sys].[databases] A
		LEFT JOIN [dbo].[dtx_tb_Ignore_Databases] B ON A.[name] = B.[Nm_Database]
...
GO
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Job_Disabled') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Job_Disabled
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
CREATE PROCEDURE [dbo].dtx_sp_Alert_Job_Disabled
AS
BEGIN
	SET NOCOUNT ON
	...
	-- Insert the new Data
	INSERT INTO dtx_tb_Status_Job_SQL_Agent(Name, Dt_Referencia, Date_Modified, Fl_Status)
	select A.name , CAST(GETDATE() AS DATE),A.date_modified, enabled 
	FROM msdb.dbo.sysjobs A
		LEFT JOIN dtx_tb_Status_Job_SQL_Agent B ON A.name = B.Name AND B.Dt_Referencia = CAST(GETDATE() AS DATE)
	WHERE B.Name IS NULL 

	-- Keep Just 7 days of information
	DELETE FROM dbo.dtx_tb_Status_Job_SQL_Agent
	WHERE Dt_Referencia = CAST(GETDATE()-7 AS DATE)
	
	SELECT B.* 
	INTO #Job_Disabled
	FROM dtx_tb_Status_Job_SQL_Agent A
		JOIN dtx_tb_Status_Job_SQL_Agent B ON A.Name = B.Name
...
-- Used on the next alert - dtx_sp_Alert_Job_Failed
...
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Job_Failed') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Job_Failed
GO

CREATE PROCEDURE [dbo].dtx_sp_Alert_Job_Failed
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Login_Failed') IS NOT NULL )
	DROP PROCEDURE [dbo].dtx_sp_Alert_Login_Failed
GO
/*******************************************************************************************************************************
--	ALERTA: Falhas Login SQL
*******************************************************************************************************************************/
CREATE procedure [dbo].dtx_sp_Alert_Login_Failed
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Long_Runnning_Process') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Long_Runnning_Process
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
CREATE PROCEDURE [dbo].[dtx_sp_Alert_Long_Runnning_Process]
AS
BEGIN  
...
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Slow_File_Growth') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Slow_File_Growth
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
CREATE PROCEDURE [dbo].dtx_sp_Alert_Slow_File_Growth
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Without_Clear') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Without_Clear
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
*******************************************************************************************************************************/
CREATE PROCEDURE [dbo].dtx_sp_Alert_Without_Clear
AS
BEGIN
	SET NOCOUNT ON
	SET DATEFORMAT YMD
...
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Rebuild_Failed') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Rebuild_Failed
GO
USE [DBADataex]
GO
/****** Object:  StoredProcedure [dbo].[dtx_sp_Alert_Rebuild_Failed]    Script Date: 7/29/2019 5:48:13 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE [dbo].[dtx_sp_Alert_Rebuild_Failed]
AS
BEGIN
	SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Send_Mail_Executing_Process') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Send_Mail_Executing_Process
GO
...
CREATE PROCEDURE [dbo].dtx_sp_Send_Mail_Executing_Process
AS
BEGIN
	SET NOCOUNT ON
...
IF OBJECT_ID('[dbo].[dtx_sp_SQLServer_Configuration]') is not null
	DROP PROCEDURE [dbo].[dtx_sp_SQLServer_Configuration]
GO

Create PROCEDURE [dbo].[dtx_sp_SQLServer_Configuration]
AS
BEGIN
...
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Severity]') IS NOT NULL )
	DROP PROCEDURE [dbo].dtx_sp_Alert_Severity
GO

CREATE PROCEDURE dtx_sp_Alert_Severity
AS
BEGIN
	--------------------------------------------------------------------------------------------------------------------------------
	...
	EXEC [msdb].[dbo].[sp_add_notification]
			...
			@operator_name = N'DTX_DBA_Operator', 
...
GO
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Slow_Queries') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Slow_Queries
GO

CREATE PROCEDURE [dbo].dtx_sp_Alert_Slow_Queries
AS
BEGIN
	...
	BEGIN
			...
			SELECT @Company_Link = Company_Link,
				@Line_Space = Line_Space,
				@Header_Default = Header
			FROM dtx_tb_dtx_tb_HTML_Parameter			
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_CheckDB]') IS NOT NULL )
	DROP PROCEDURE [dbo].dtx_sp_Alert_CheckDB
GO
CREATE PROCEDURE [dbo].dtx_sp_Alert_CheckDB 
AS
BEGIN
	SET NOCOUNT ON
...
IF ( OBJECT_ID('[dbo].dtx_sp_Alert_Database_Errors') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Database_Errors
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
...
CREATE PROCEDURE [dbo].dtx_sp_Alert_Database_Errors
AS
BEGIN
		SET NOCOUNT ON
...
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Every_Minute]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Every_Minute
GO



CREATE PROCEDURE dbo.dtx_sp_Alert_Every_Minute
AS
BEGIN
...
GO
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Alert_Every_Day]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Alert_Every_Day
GO

CREATE PROCEDURE dbo.dtx_sp_Alert_Every_Day
AS
BEGIN
	--Alertas Diarios 
	EXEC dbo.dtx_sp_WhoIsActive_Result

	EXEC dbo.dtx_sp_Alert_Long_Runnning_Process
	
	EXEC dbo.dtx_sp_Read_Error_log 0
		
	EXEC dbo.dtx_sp_Alert_Slow_Disk 'Slow Disk' 

	EXEC dbo.dtx_sp_Alert_Database_Created

	EXEC dbo.dtx_sp_Alert_Database_Without_Backup

	EXEC dbo.dtx_sp_Alert_Job_Disabled

	EXEC dbo.dtx_sp_Alert_Job_Failed

	EXEC dbo.dtx_sp_Alert_Login_Failed
	
	EXEC dbo.dtx_sp_Alert_Slow_File_Growth

	EXEC dbo.dtx_sp_Alert_Without_Clear

	---- Put after the Rebuild Job
	--EXEC dbo.dtx_sp_Alert_Rebuild_Failed

	--Enable if use deadlock
	--EXEC dbo.dtx_sp_Alert_DeadLocks
	
	EXEC dtx_sp_Alert_Database_Growth

	-- Once a month
	IF DATEPART(dd,GETDATE()) = 1
		EXEC dbo.dtx_sp_SQLServer_Configuration
			
	IF EXISTS (SELECT * FROM dtx_tb_Alert_Parameter WHERE Nm_Alert = 'Database Errors' AND Fl_Enable = 1)
		EXEC dbo.dtx_sp_Alert_Database_Errors

		--Every Monday
	IF DATEPART(dw,GETDATE()) = 2
		EXEC dbo.dtx_sp_Alert_Index_Fragmentation

END
	
GO
IF ( OBJECT_ID('[dbo].[dtx_sp_Test_Alerts]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Test_Alerts
GO

CREATE PROCEDURE dtx_sp_Test_Alerts
AS
BEGIN
	EXEC dtx_sp_WhoIsActive_Result
	...
	EXEC dtx_sp_Alert_Database_Without_Log_Backup
	...
	EXEC dtx_sp_Alert_SQLServer_Connection
	...
	EXEC dtx_sp_Alert_Long_Runnning_Process
	...
	EXEC dtx_sp_Alert_Tempdb_MDF_File_Utilization
	...
	EXEC [dtx_sp_Alert_CPU_Utilization]
	...
	EXEC dtx_sp_Alert_Memory_Available
	...
	EXEC dtx_sp_Alert_Large_LDF_File
	...
	EXEC dtx_sp_Alert_SQLServer_Restarted
	...
	EXEC dtx_sp_Alert_Database_Without_Backup
	...
	EXEC dtx_sp_Alert_Page_Corruption



	----------
	EXEC dtx_sp_Read_Error_log @Actual_Log = 1
	EXEC dtx_sp_Alert_Slow_Disk @Nm_Alert = 'Slow Disk'
	...
	EXEC dtx_sp_Alert_Login_Failed
	...
	EXEC dtx_sp_Alert_Slow_File_Growth
...
--------------------------
	...
	---------------
	EXEC dbo.dtx_sp_Send_Mail_Executing_Process

	--------------
	EXEC dtx_sp_Alert_Without_Clear

	--------------

	EXEC dtx_sp_SQLServer_Configuration
...
GO
IF EXISTS (SELECT job_id FROM msdb.dbo.sysjobs_view WHERE name = N'DataEX - Alert DB - Every Minute')
EXEC msdb.dbo.sp_delete_job @job_name=N'DataEX - Alert DB - Every Minute', @delete_unused_schedule=1
GO
GO
...
BEGIN TRANSACTION
	...
	EXEC @ReturnCode = [msdb].[dbo].[sp_add_job] 
			@job_name = N'DataEX - Alert DB - Every Minute', 
			@enabled = 1, 
	...
	------------------------------------------------------------------------------------------------------------------------------------	
	-- Cria o Step 1 do JOB - DataEX - Alertas Banco de Dados
	------------------------------------------------------------------------------------------------------------------------------------
	EXEC @ReturnCode = [msdb].[dbo].[sp_add_jobstep] 
			@job_id = @jobId,
			@step_name = N'DataEX - Alert Databases',
			@step_id = 1,
			...
			@os_run_priority = 0,
			@subsystem = N'TSQL',
			@command = N'exec dbo.dtx_sp_Alert_Every_Minute', 
	...
	EXEC @ReturnCode = [msdb].[dbo].[sp_add_jobschedule] 
			@job_id = @jobId, 
			@name = N'DataEX - Alertas Banco de Dados', 
			@enabled = 1, 
			@freq_type = 4, 
			@freq_interval = 1, 
			@freq_subday_type = 4, 
...
GO
IF EXISTS (SELECT job_id FROM msdb.dbo.sysjobs_view WHERE name = N'DataEX - Alert DB - Every Day')
EXEC msdb.dbo.sp_delete_job @job_name=N'DataEX - Alert DB - Every Day', @delete_unused_schedule=1
GO
GO
...
BEGIN TRANSACTION
	...
	DECLARE @jobId BINARY(16)
	EXEC @ReturnCode = [msdb].[dbo].[sp_add_job] 
			@job_name = N'DataEX - Alert DB - Every Day', 
			@enabled = 1, 
			@notify_level_eventlog = 0,
			@notify_level_email = 2,
			@notify_level_netsend = 0,
			...
			@category_name = N'Database Maintenance',
			@owner_login_name = N'sa', 
			@notify_email_operator_name=N'DTX_DBA_Operator',
			@job_id = @jobId OUTPUT
	...
	EXEC @ReturnCode = [msdb].[dbo].[sp_add_jobstep] 
			...
			@os_run_priority = 0,
			@subsystem = N'TSQL',
			@command = N'exec dbo.dtx_sp_Alert_Every_Day', 
			@database_name = N'DBADataex', 
			@flags = 0
	...
	EXEC @ReturnCode = [msdb].[dbo].[sp_add_jobschedule] 
			@job_id = @jobId, 
			@name = N'DataEX - Alert DB - Every Day', 
		@enabled=1, 
			@freq_type=4, 
			@freq_interval=1, 
			@freq_subday_type=1, 
...
GO
IF EXISTS (SELECT job_id FROM msdb.dbo.sysjobs_view WHERE name = N'DataEX - Send Mail Whoisactive')
EXEC msdb.dbo.sp_delete_job @job_name=N'DataEX - Send Mail Whoisactive', @delete_unused_schedule=1
GO
...
BEGIN TRANSACTION
	...
	DECLARE @jobId BINARY(16)
	EXEC @ReturnCode = [msdb].[dbo].[sp_add_job]
			@job_name = N'DataEX - Send Mail Whoisactive',
			@enabled = 1,
			@notify_level_eventlog = 0,
			@notify_level_email = 2,
			@notify_level_netsend = 0,
	...
	EXEC @ReturnCode = [msdb].[dbo].[sp_add_jobstep] 
			...
			@os_run_priority = 0, 
			@subsystem = N'TSQL',
			@command = N'exec dtx_sp_WhoIsActive_Result
						exec [dtx_sp_Send_Mail_Executing_Process]',
			@database_name = N'DBADataex',
			@flags = 0
