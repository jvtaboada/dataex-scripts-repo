...
Procedures:
dtx_sp_CheckList_Alert
dtx_sp_CheckList_AutoGrowth
dtx_sp_CheckList_Backup_Executed
dtx_sp_CheckList_Changed_Jobs
dtx_sp_CheckList_Counters
dtx_sp_CheckList_Database_Growth
dtx_sp_CheckList_Database_Without_Backup
dtx_sp_CheckList_Disk_Space
dtx_sp_CheckList_File_Utilization
dtx_sp_CheckList_Index_Fragmentation
dtx_sp_CheckList_Jobs_Failed
dtx_sp_CheckList_Jobs_Running
dtx_sp_CheckList_MDF_LDF_Files
dtx_sp_CheckList_Open_Connection
dtx_sp_CheckList_Queries_Running
dtx_sp_Checklist_Slow_Jobs
dtx_sp_CheckList_SQLServer_ErrorLog
dtx_sp_CheckList_Table_Growth
dtx_sp_CheckList_DBADataEX_Queries
dtx_sp_CheckList_Waits_Stats
dtx_sp_Load_CheckList_Information
dtx_sp_Load_File_Utilization
dtx_sp_Load_SQL_Counter
dtx_sp_Load_Table_Size
dtx_sp_Load_Waits_Stats_History
dtx_sp_Send_Mail_CheckList_DBA
dtx_sp_Waits_Stats_History
...
CheckList_DBADataEX_Queries
CheckList_DBADataEX_Queries_LastDays
...
Views:
dtx_vw_Index_Fragmentation_History
vwTable_Size

Jobs:
DataEX - CheckList SQL Server Instance
DataEX - Load SQL Server Files Performance
DataEX - Load SQL Server Counters
DataEX - Load Table Size
DataEX - Wait Stats Load

*/

GO
IF ( OBJECT_ID('[dbo].[dtx_tb_CheckList_Parameter]') IS NOT NULL )
	DROP TABLE [dbo].dtx_tb_CheckList_Parameter;

CREATE TABLE dtx_tb_CheckList_Parameter(
	Id_CheckList TINYINT IDENTITY,
	Nm_Procedure VARCHAR(100),
	Fl_Enabled BIT)

INSERT INTO dtx_tb_CheckList_Parameter(Nm_Procedure,Fl_Enabled)
VALUES('dtx_sp_CheckList_Disk_Space',1),
	('dtx_sp_CheckList_MDF_LDF_Files',1),
	('dtx_sp_CheckList_Database_Growth',1),
	('dtx_sp_CheckList_Table_Growth',1),
	('dtx_sp_CheckList_File_Utilization',1),
	('dtx_sp_CheckList_Database_Without_Backup',1),
	('dtx_sp_CheckList_Backup_Executed',1),
	('dtx_sp_CheckList_Queries_Running',1),
	('dtx_sp_CheckList_Changed_Jobs',1),
	('dtx_sp_CheckList_Jobs_Failed',1),
	('dtx_sp_Checklist_Slow_Jobs',1),
	('dtx_sp_CheckList_Jobs_Running',1),
	('dtx_sp_CheckList_Open_Connection',1),
	('dtx_sp_CheckList_Profile_Queries',1),
	('dtx_sp_CheckList_Counters',1),
	('dtx_sp_CheckList_Index_Fragmentation',1),
	('dtx_sp_CheckList_Waits_Stats',1),
	('dtx_sp_CheckList_SQLServer_ErrorLog',1),
	('dtx_sp_CheckList_Alert',1),
	('dtx_sp_CheckList_AutoGrowth',1)

GO

IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Disk_Space]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Disk_Space]

CREATE TABLE [dbo].[dtx_tb_CheckList_Disk_Space] (
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Data_Files]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Data_Files]

CREATE TABLE [dbo].[dtx_tb_CheckList_Data_Files] (
	[Server]			VARCHAR(500),
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Log_Files]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Log_Files]

CREATE TABLE [dbo].[dtx_tb_CheckList_Log_Files] (
	[Server]			VARCHAR(500),
	[Nm_Database]		VARCHAR(500),
	[Logical_Name]		VARCHAR(500),
	[FileName]			VARCHAR(500),
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Database_Growth]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Database_Growth]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Database_Growth] (
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Database_Growth_Email]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Database_Growth_Email]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Database_Growth_Email] (
	[Nm_Server]	VARCHAR(50) NULL,
	[Nm_Database]	VARCHAR(100) NULL,
	[Actual_Size] NUMERIC(38, 2) NULL,
	[Growth_1_day]	NUMERIC(38, 2) NULL,
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Table_Growth]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Table_Growth]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Table_Growth] (
	[Nm_Server]	VARCHAR(50) NULL,
	[Nm_Database]	VARCHAR(100) NULL,
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Table_Growth_Email]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Table_Growth_Email]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Table_Growth_Email] (
	[Nm_Server]	VARCHAR(50) NULL,
	[Nm_Database]	VARCHAR(100) NULL,
	[Nm_Table]		VARCHAR(100) NULL,
	[Actual_Size] NUMERIC(38, 2) NULL,
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_File_Writes]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_File_Writes]

CREATE TABLE [dbo].[dtx_tb_CheckList_File_Writes](
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_File_Reads]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_File_Reads]

CREATE TABLE [dbo].[dtx_tb_CheckList_File_Reads](
	[Nm_Database] [nvarchar](200) NOT NULL,
	[file_id] [smallint] NULL,
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Database_Without_Backup]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Database_Without_Backup]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Database_Without_Backup] (
	[Nm_Database] VARCHAR(100) NOT NULL	
)

IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Backup_Executed]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Backup_Executed]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Backup_Executed] (
...
IF ( OBJECT_ID('[dbo].[dtx_tb_CheckList_Queries_Running]') IS NOT NULL )
	DROP TABLE [dbo].[dtx_tb_CheckList_Queries_Running]
				
CREATE TABLE [dbo].[dtx_tb_CheckList_Queries_Running] (		
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Jobs_Failed]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Jobs_Failed]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Jobs_Failed] (
	[Server]		VARCHAR(500),
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Changed_Jobs]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Changed_Jobs]

CREATE TABLE [dbo].[dtx_tb_CheckList_Changed_Jobs] (
	[Nm_Job]			VARCHAR(1000),
	[Fl_Enabled]		TINYINT,
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Slow_Jobs]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Slow_Jobs]

CREATE TABLE [dbo].[dtx_tb_CheckList_Slow_Jobs] (
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Jobs_Running]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Jobs_Running]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Jobs_Running](
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Profile_Queries]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Profile_Queries]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Profile_Queries] (
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Profile_Queries_LastDays]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Profile_Queries_LastDays]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Profile_Queries_LastDays] (
	[Date]	VARCHAR(50),
	[QTD]	INT
)

IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Conexao_Aberta]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Conexao_Aberta]

CREATE TABLE [dbo].[dtx_tb_CheckList_Conexao_Aberta](
	[login_name] [nvarchar](256) NULL,
	[session_count] [int] NULL
) ON [PRIMARY]

IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Opened_Connections_Email]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Opened_Connections_Email]

CREATE TABLE [dbo].[dtx_tb_CheckList_Opened_Connections_Email](
	[Nr_Order] INT NULL,
	[login_name] [nvarchar](256) NULL,
	[session_count] [int] NULL
) ON [PRIMARY]

IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Counters]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Counters]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Counters] (
	[Hour]			TINYINT,
	[Nm_Counter]	VARCHAR(60),
	[AVG]			BIGINT
)

IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Counters_Email]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Counters_Email]

CREATE TABLE [dbo].[dtx_tb_CheckList_Counters_Email](
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Waits_Stats]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Waits_Stats]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_Waits_Stats] (
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_SQLServer_LoginFailed]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_SQLServer_LoginFailed]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_SQLServer_LoginFailed] (	
	[Text]		VARCHAR(MAX),
	[Qt_Error]	INT
)

IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_SQLServer_LoginFailed_Email]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_SQLServer_LoginFailed_Email]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_SQLServer_LoginFailed_Email] (
	[Nr_Order]	INT,
	[Text]		VARCHAR(MAX),
	[Qt_Error]	INT
)

IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_SQLServer_ErrorLog]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_SQLServer_ErrorLog]
	
CREATE TABLE [dbo].[dtx_tb_CheckList_SQLServer_ErrorLog] (
	[Dt_Log]		DATETIME,
	[ProcessInfo]	VARCHAR(100),
	[Text]			VARCHAR(MAX)
)

IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Database_Auto_Growth]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Database_Auto_Growth]

CREATE TABLE [dbo].[dtx_tb_CheckList_Database_Auto_Growth](
...
if object_id('dtx_vw_Index_Fragmentation_History') is not null
	drop View dtx_vw_Index_Fragmentation_History

GO
create view dtx_vw_Index_Fragmentation_History
AS
...
from dtx_tb_Index_Fragmentation_History A
	join dtx_tb_User_Server B on A.Id_Server = B.Id_Server
	join dtx_tb_User_Database C on A.Id_Database = C.Id_Database
	join dtx_tb_User_Table D on A.Id_Table = D.Id_Table
GO



IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Disk_Space]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Disk_Space]
GO

GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Disk_Space]
AS
BEGIN
	SET NOCOUNT ON 

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Disk_Space]

	IF NOT EXISTS (SELECT Fl_Enabled FROM dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Disk_Space' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Disk_Space]( [DriveName], [TotalSize_GB], [FreeSpace_GB], [SpaceUsed_GB], [SpaceUsed_Percent] )
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_MDF_LDF_Files]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_MDF_LDF_Files]
GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_MDF_LDF_Files]
AS
BEGIN
	SET NOCOUNT ON

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Data_Files]
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Log_Files]

	IF NOT EXISTS (SELECT Fl_Enabled FROM dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_MDF_LDF_Files' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Data_Files] (	[Server], [Nm_Database], [Logical_Name], [FileName], [Total_Reserved], [Total_Used], 
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Log_Files] (	[Server], [Nm_Database], [Logical_Name], [FileName], [Total_Reserved], [Total_Used], 
													[Free_Space (MB)], [Free_Space (%)], [MaxSize], [Growth] )
	SELECT	@@SERVERNAME AS [Server],
			DB_NAME(A.database_id) AS [Nm_Database],
			[name] AS [Logical_Name],
...
if object_id('dtx_vw_Table_Size') is not null
	drop view dtx_vw_Table_Size
GO

CREATE VIEW [dbo].dtx_vw_Table_Size
AS

select	A.Dt_Log, B.Nm_Server, C.Nm_Database,D.Nm_Table ,A.Nm_Drive, 
		A.Nr_Total_Size, A.Nr_Data_Size, A.Nr_Index_Size, A.Qt_Rows
from dtx_tb_Table_Size_History A
	join dtx_tb_User_Server B on A.Id_Server = B.Id_Server
	join dtx_tb_User_Database C on A.Id_Database = C.Id_Database
	join dtx_tb_User_Table D on A.Id_Table = D.Id_Table

GO
if object_id('dtx_sp_Load_Table_Size') is not null
	drop procedure dtx_sp_Load_Table_Size
GO
CREATE proc [dbo].[dtx_sp_Load_Table_Size]
AS
BEGIN
	...
	INSERT INTO dbo.dtx_tb_User_Server(Nm_Server)
	SELECT DISTINCT A.Nm_Server 
	FROM ##Table_Size A
		LEFT JOIN dbo.dtx_tb_User_Server B ON A.Nm_Server = B.Nm_Server
	WHERE B.Nm_Server IS null
		
	INSERT INTO dbo.dtx_tb_User_Database(Nm_Database)
	SELECT DISTINCT A.Nm_Database 
	FROM ##Table_Size A
		LEFT JOIN dbo.dtx_tb_User_Database B ON A.Nm_Database = B.Nm_Database
	WHERE B.Nm_Database IS null
	
	INSERT INTO dbo.dtx_tb_User_Table(Nm_Table)
	SELECT DISTINCT A.Nm_Table 
	FROM ##Table_Size A
		LEFT JOIN dbo.dtx_tb_User_Table B ON A.Nm_Table = B.Nm_Table
	WHERE B.Nm_Table IS null	

	insert into dbo.dtx_tb_Table_Size_History(Id_Server, Id_Database, Id_Table, Nm_Drive, 
	...
	from ##Table_Size A
		JOIN dbo.dtx_tb_User_Server B ON A.Nm_Server = B.Nm_Server 
		JOIN dbo.dtx_tb_User_Table C ON A.Nm_Table = C.Nm_Table
		JOIN dbo.dtx_tb_User_Database D ON A.Nm_Database = D.Nm_Database
		LEFT JOIN dbo.dtx_tb_Table_Size_History E ON	B.Id_Server = E.Id_Server 
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Database_Growth]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Database_Growth]
GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Database_Growth]
AS
BEGIN
	SET NOCOUNT ON

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Database_Growth]
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Database_Growth_Email]

	IF NOT EXISTS (SELECT Fl_Enabled FROM dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Database_Growth' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	FROM [dbo].[dtx_tb_Table_Size_History] A
		JOIN [dbo].dtx_tb_User_Server B ON A.[Id_Server] = B.[Id_Server] 
		JOIN [dbo].dtx_tb_User_Table C ON A.[Id_Table] = C.[Id_Table]
		JOIN [dbo].dtx_tb_User_Database D ON A.[Id_Database] = D.[Id_Database]
	...
	*/
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Database_Growth] ( [Nm_Server], [Nm_Database], [Actual_Size], [Growth_1_day], [Growth_15_days], [Growth_30_days], [Growth_60_days] )
	...
	IF (@@ROWCOUNT <> 0)
	BEGIN
		INSERT INTO [dbo].[dtx_tb_CheckList_Database_Growth_Email] ( [Nm_Server], [Nm_Database], [Actual_Size], [Growth_1_day], [Growth_15_days], [Growth_30_days], [Growth_60_days] )
		SELECT	TOP 10
				[Nm_Server], [Nm_Database], [Actual_Size], [Growth_1_day], [Growth_15_days], [Growth_30_days], [Growth_60_days]
		FROM [dbo].[dtx_tb_CheckList_Database_Growth]
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Table_Growth]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Table_Growth]	
GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Table_Growth]
AS
BEGIN
	SET NOCOUNT ON
				
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Table_Growth]
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Table_Growth_Email]

	IF NOT EXISTS (SELECT Fl_Enabled FROM dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Table_Growth' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	*/
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Table_Growth] ( [Nm_Server], [Nm_Database], [Nm_Table], [Actual_Size], [Growth_1_day], [Growth_15_days], [Growth_30_days], [Growth_60_days] )
	...
	IF (@@ROWCOUNT <> 0)
	BEGIN
		INSERT INTO [dbo].[dtx_tb_CheckList_Table_Growth_Email] ( [Nm_Server], [Nm_Database], [Nm_Table], [Actual_Size], [Growth_1_day], [Growth_15_days], [Growth_30_days], [Growth_60_days] )
		SELECT	TOP 10
				[Nm_Server], [Nm_Database], [Nm_Table], [Actual_Size], [Growth_1_day], [Growth_15_days], [Growth_30_days], [Growth_60_days]
		FROM [dbo].[dtx_tb_CheckList_Table_Growth]
		ORDER BY ABS([Growth_1_day]) DESC, ABS([Growth_15_days]) DESC, ABS([Growth_30_days]) DESC, ABS([Growth_60_days]) DESC, [Actual_Size] DESC
...
IF (OBJECT_ID('[dbo].[dtx_sp_Load_File_Utilization]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_Load_File_Utilization]
GO

CREATE PROCEDURE [dbo].[dtx_sp_Load_File_Utilization]
AS
BEGIN
	INSERT INTO dbo.dtx_tb_File_Utilization_History
...
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_File_Utilization]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_File_Utilization]	
GO	

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_File_Utilization]
AS
BEGIN

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_File_Writes]
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_File_Reads]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_File_Utilization' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	into #file_writes		  
	from [dbo].dtx_tb_File_Utilization_History A
	JOIN [dbo].dtx_tb_File_Utilization_History B on	A.Nm_Database = B.Nm_Database and A.file_id = B.file_id
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_File_Writes]
	SELECT *
	FROM #file_writes
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_File_Reads]
	SELECT *
	FROM #file_reads
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Database_Without_Backup]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Database_Without_Backup]	
GO	
	
CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Database_Without_Backup]
AS
BEGIN

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Database_Without_Backup]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Database_Without_Backup' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	LEFT JOIN [dbo].[dtx_tb_Ignore_Databases] C ON A.[name] = C.[Nm_Database]
	WHERE	B.[database_name] IS NULL
			and C.[Nm_Database] IS NULL
			AND A.[name] NOT IN ('tempdb','ReportServerTempDB') 
			AND state_desc <> 'OFFLINE'
		
	INSERT INTO [dbo].[dtx_tb_CheckList_Database_Without_Backup] (Nm_Database)
	select Nm_Database 
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Backup_Executed]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Backup_Executed]	
GO	
	
CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Backup_Executed]
AS
BEGIN
	SET NOCOUNT ON
	...
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Backup_Executed]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Backup_Executed' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END

	
	INSERT INTO [dbo].[dtx_tb_CheckList_Backup_Executed] (	[Database_Name], [Name], [Backup_Start_Date], [Tempo_Min], [Position], [Server_Name],
...
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Queries_Running]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Queries_Running]
GO


CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Queries_Running]
AS
BEGIN
	SET NOCOUNT ON 

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Queries_Running]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Queries_Running' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Queries_Running]
	SELECT * FROM #Whoisactive_Result

	IF (@@ROWCOUNT = 0)
	BEGIN
		INSERT INTO [dbo].[dtx_tb_CheckList_Queries_Running]( [dd hh:mm:ss.mss], database_name, login_name, host_name, start_time, status, session_id, blocking_session_id, wait_info, open_tran_count, CPU, reads, CPU_delta, reads_delta, writes, sql_command )
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Changed_Jobs]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Changed_Jobs]
GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Changed_Jobs]
AS
BEGIN

	SET NOCOUNT ON

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Changed_Jobs]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Changed_Jobs' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Changed_Jobs] ( [Nm_Job], [Fl_Enabled], [Dt_Creation], [Dt_Alteration], [Nr_Version] )
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Jobs_Failed]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Jobs_Failed]
GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Jobs_Failed]
AS
BEGIN
	SET NOCOUNT ON

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Jobs_Failed]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Jobs_Failed' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Jobs_Failed] ( [Server], [Job_Name], [Status], [Dt_Execution], [Run_Duration], [SQL_Message] )
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_Checklist_Slow_Jobs]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_Checklist_Slow_Jobs]	
GO	

CREATE PROCEDURE [dbo].[dtx_sp_Checklist_Slow_Jobs]
AS
BEGIN
	SET NOCOUNT ON

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Slow_Jobs]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_Checklist_Slow_Jobs' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Slow_Jobs] ( [Job_Name], [Status], [Dt_Execution], [Run_Duration], [SQL_Message] )
	SELECT	[Job_Name], 
			CASE	WHEN [Run_Status] = 0 THEN 'Failed'
					WHEN [Run_Status] = 1 THEN 'Succeeded'
					WHEN [Run_Status] = 2 THEN 'Retry (step only)'
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Jobs_Running]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Jobs_Running]	
GO	


CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Jobs_Running]
AS
BEGIN
	SET NOCOUNT ON

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Jobs_Running]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Jobs_Running' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END

	INSERT INTO [dbo].[dtx_tb_CheckList_Jobs_Running] (Nm_JOB, Dt_Start, Duration, Nm_Step)
	SELECT
		j.name AS Nm_JOB,
...
GO	
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Open_Connection]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Open_Connection]	
GO	


CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Open_Connection]
AS
BEGIN
	SET NOCOUNT ON

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Conexao_Aberta]
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Opened_Connections_Email]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Open_Connection' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END


	INSERT INTO [dbo].[dtx_tb_CheckList_Conexao_Aberta] ([login_name], [session_count])
	...
	IF (@@ROWCOUNT <> 0)
	BEGIN
		INSERT INTO [dbo].[dtx_tb_CheckList_Opened_Connections_Email] ([Nr_Order], [login_name], [session_count])
		SELECT TOP 10 1, [login_name], [session_count]
		FROM [dbo].[dtx_tb_CheckList_Conexao_Aberta]
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Profile_Queries]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Profile_Queries]	
GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Profile_Queries]
AS
BEGIN
	SET NOCOUNT ON

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Profile_Queries]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Profile_Queries' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	INTO #Slow_Queries
	FROM [dbo].[dtx_tb_Queries_Profile] (nolock)
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Profile_Queries] ( [PrefixoQuery], [QTD], [Total], [AVG], [MIN], [MAX], [Writes], [CPU], [Reads], [Ordem] )
	...
	BEGIN
		...
		FROM [dbo].[dtx_tb_CheckList_Profile_Queries]
	END
	ELSE
	BEGIN
		INSERT INTO [dbo].[dtx_tb_CheckList_Profile_Queries] ( [PrefixoQuery], [QTD], [Total], [AVG], [MIN], [MAX], [Writes], [CPU], [Reads], [Ordem] )	
	...
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Profile_Queries_LastDays]
		
	INSERT INTO [dbo].[dtx_tb_CheckList_Profile_Queries_LastDays] ( [Date], [QTD] )
	SELECT [Date], [QTD]
	FROM #Slow_All
...
if OBJECT_ID('dtx_sp_Load_SQL_Counter') is not null
	drop procedure dtx_sp_Load_SQL_Counter

GO
CREATE PROCEDURE dtx_sp_Load_SQL_Counter
AS
begin
 ...
 where counter_name = 'User Connections'  
	 ...
	 insert INTO dtx_tb_Log_Counter(Dt_Log,Id_Counter,Value)  
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Counters]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Counters]
GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Counters]
AS
BEGIN
	SET NOCOUNT ON

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Counters]
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Counters_Email]

		IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Counters' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Counters]( [Hour], [Nm_Counter], [AVG] )
	SELECT DATEPART(hh, [Dt_Log]) AS [Hour], [Nm_Counter], AVG(CAST([Value] as bigint)) AS [AVG]
	FROM [dbo].[dtx_tb_Log_Counter] A
		JOIN [dbo].[dtx_tb_SQL_Counter] B ON A.[Id_Counter] = B.[Id_Counter]
	...
	FROM [dbo].[dtx_tb_Queries_Profile]
	...
	IF NOT EXISTS (SELECT TOP 1 NULL FROM [dbo].[dtx_tb_CheckList_Counters])
	BEGIN
		INSERT INTO [dbo].[dtx_tb_CheckList_Counters]( [Hour], [Nm_Counter], [AVG] )
		SELECT NULL, 'Without Information about Counters', NULL
	END
		
	INSERT INTO [dbo].[dtx_tb_CheckList_Counters_Email]
	...
	FROM [dbo].[dtx_tb_CheckList_Counters] AS C
	PIVOT	(
				SUM([AVG]) 
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Index_Fragmentation]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Index_Fragmentation]
GO
CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Index_Fragmentation]
AS
BEGIN
	SET NOCOUNT ON
	...
	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Index_Fragmentation' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	SELECT @Max_Dt_Log = MAX(Dt_Log) FROM [dbo].dtx_vw_Index_Fragmentation_History
	...
	SELECT	[Dt_Log], [Nm_Server], [Nm_Database], [Nm_Table], [Nm_Index], 
			[Avg_Fragmentation_In_Percent], [Page_Count], [Fill_Factor], [Fl_Compression]
	FROM [dbo].dtx_vw_Index_Fragmentation_History
...
if object_id('dtx_sp_Load_Waits_Stats_History') is not null
	drop procedure dtx_sp_Load_Waits_Stats_History
GO
CREATE procedure [dbo].dtx_sp_Load_Waits_Stats_History
AS
declare @Waits_Before table (WaitType varchar(60), WaitCount bigint, Id_Store int)
declare @Id_Store int

select @Id_Store = Id_Store
from dtx_tb_Waits_Stats_History A
	join (select max(Id_Waits_Stats_History)  Id_Waits_Stats_History
	from dtx_tb_Waits_Stats_History) B on A.Id_Waits_Stats_History = B.Id_Waits_Stats_History
...
from dtx_tb_Waits_Stats_History A
	join (select [WaitType], max(Id_Waits_Stats_History) Id_Waits_Stats_History
		from dtx_tb_Waits_Stats_History
...
INSERT INTO dtx_tb_Waits_Stats_History(WaitType,Wait_S,Resource_S,Signal_S,WaitCount,Percentage,Id_Store)
SELECT
...
begin
	INSERT INTO dtx_tb_Waits_Stats_History(WaitType)
	values('RESET WAITS STATS')
END
GO


if object_id('dtx_sp_Waits_Stats_History') is not null
	drop procedure dtx_sp_Waits_Stats_History
GO
CREATE procedure [dbo].[dtx_sp_Waits_Stats_History] @Dt_Start datetime, @Dt_Final datetime
AS
BEGIN
...
from dtx_tb_Waits_Stats_History (nolock)
...
from @Wait_Stats A
join dtx_tb_Waits_Stats_History B on A.Min_Id = B.Id_Waits_Stats_History -- Primeiro
join dtx_tb_Waits_Stats_History C on A.Max_Id = C.Id_Waits_Stats_History -- Último
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Waits_Stats]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Waits_Stats]
GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Waits_Stats]
AS
BEGIN
	SET NOCOUNT ON

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Waits_Stats]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Waits_Stats' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Waits_Stats](	[WaitType], [Min_Log], [Max_Log], [DIf_Wait_S], [DIf_Resource_S], [DIf_Signal_S], 
												[DIf_WaitCount], [DIf_Percentage], [Last_Percentage] )
	EXEC [dbo].[dtx_sp_Waits_Stats_History] @Dt_Start, @Dt_End
...
GO
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_SQLServer_ErrorLog]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_SQLServer_ErrorLog]
GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_SQLServer_ErrorLog]
AS
BEGIN
	SET NOCOUNT ON

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_SQLServer_ErrorLog' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_SQLServer_ErrorLog]
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_SQLServer_LoginFailed]
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_SQLServer_LoginFailed_Email]

	-- Login Failed
	INSERT INTO [dbo].[dtx_tb_CheckList_SQLServer_LoginFailed]( [Text], [Qt_Error] )
	...
	IF (@@ROWCOUNT <> 0)
	BEGIN
		INSERT INTO [dbo].[dtx_tb_CheckList_SQLServer_LoginFailed_Email]( [Nr_Order], [Text], [Qt_Error] )
		SELECT TOP 10 1, [Text], [Qt_Error]
		FROM [dbo].[dtx_tb_CheckList_SQLServer_LoginFailed]
	...
	ELSE
	BEGIN
		INSERT INTO [dbo].[dtx_tb_CheckList_SQLServer_LoginFailed_Email]( [Text], [Qt_Error] )
		SELECT 'Without Information about Login Failed', NULL
	END
	
	-- Error Log
	INSERT INTO [dbo].[dtx_tb_CheckList_SQLServer_ErrorLog]( [Dt_Log], [ProcessInfo], [Text] )
...
GO
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Alert]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Alert]

CREATE TABLE [dbo].[dtx_tb_CheckList_Alert] (
...
IF (OBJECT_ID('[dbo].[dtx_tb_CheckList_Alert_Sem_Clear]') IS NOT NULL)
	DROP TABLE [dbo].[dtx_tb_CheckList_Alert_Sem_Clear]

CREATE TABLE [dbo].[dtx_tb_CheckList_Alert_Sem_Clear] (
	[Nm_Alert] VARCHAR(200) NULL,
	[Ds_Message] VARCHAR(200) NULL,
	[Dt_Alert] DATETIME,
	[Run_Duration] VARCHAR(18)
...
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_Alert]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_Alert]	
GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_Alert]
AS
BEGIN
	SET NOCOUNT ON

	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Alert_Sem_Clear]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_Alert' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	FROM [dbo].[dtx_tb_Alert] A WITH(NOLOCK)
	JOIN [dbo].[dtx_tb_Alert_Parameter] B WITH(NOLOCK) ON A.Id_Alert_Parameter = B.Id_Alert_Parameter
	...
	JOIN [dbo].[dtx_tb_Alert_Parameter] C WITH(NOLOCK) ON A.Id_Alert_Parameter = C.Id_Alert_Parameter
	JOIN [dbo].[dtx_tb_Alert] B ON A.Id_Alert_Parameter = C.Id_Alert_Parameter and B.Fl_Type = 1 and B.Dt_Alert < A.Dt_Alert	
	where A.Fl_Type = 0
	...
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Alert]
	
	INSERT INTO [dbo].[dtx_tb_CheckList_Alert]
	SELECT Nm_Alert, Ds_Message, Dt_Alert, Run_Duration 
	FROM #Checklist_Alert

	IF (@@ROWCOUNT = 0)
	BEGIN
		INSERT INTO [dbo].[dtx_tb_CheckList_Alert] ( [Nm_Alert], [Ds_Message], [Dt_Alert], [Run_Duration] )
		SELECT 'Without Information About Alert Last Day', NULL, NULL, NULL
	END
	
	INSERT INTO [dbo].[dtx_tb_CheckList_Alert_Sem_Clear]
	...
	FROM [dbo].[dtx_tb_Alert] A WITH(NOLOCK)
	JOIN [dbo].[dtx_tb_Alert_Parameter] B WITH(NOLOCK) ON A.Id_Alert_Parameter = B.Id_Alert_Parameter
	WHERE	[Id_Alert] = ( SELECT MAX([Id_Alert]) FROM [dbo].[dtx_tb_Alert] B WITH(NOLOCK) WHERE A.Id_Alert_Parameter = B.Id_Alert_Parameter )
			AND B.[Fl_Clear] = 1	--  CLEAR
			AND A.[Fl_Type] = 1		-- ALERTA
	 
	IF (@@ROWCOUNT = 0)
	BEGIN
		INSERT INTO [dbo].[dtx_tb_CheckList_Alert_Sem_Clear] ( [Nm_Alert], [Ds_Message], [Dt_Alert], [Run_Duration] )
...
IF (OBJECT_ID('[dbo].[dtx_sp_CheckList_AutoGrowth]') IS NOT NULL)
	DROP PROCEDURE [dbo].[dtx_sp_CheckList_AutoGrowth]	
GO

CREATE PROCEDURE [dbo].[dtx_sp_CheckList_AutoGrowth]
AS
BEGIN
	SET NOCOUNT ON
	
	TRUNCATE TABLE [dbo].[dtx_tb_CheckList_Database_Auto_Growth]

	IF NOT EXISTS (SELECT Fl_Enabled From dtx_tb_CheckList_Parameter WHERE Nm_Procedure = 'dtx_sp_CheckList_AutoGrowth' AND Fl_Enabled = 1)
	BEGIN
		RETURN
	END
	...
	INSERT INTO [dbo].[dtx_tb_CheckList_Database_Auto_Growth] ([Nm_Database],[Filename],[Duration],[StartTime],[EndTime],[Growth_Size],[ApplicationName],[HostName],[LoginName])
...
IF OBJECT_ID('[dbo].[dtx_sp_Send_Mail_CheckList_DBA]') is not null
	DROP PROCEDURE [dbo].dtx_sp_Send_Mail_CheckList_DBA
...
CREATE PROCEDURE [dbo].dtx_sp_Send_Mail_CheckList_DBA
AS
BEGIN
...
SET NOCOUNT ON
	...
	***********************************************************************************************************************************/
	...
	INTO ##Email_HTML2
	FROM [dbo].[dtx_tb_CheckList_Disk_Space]
	...
	***********************************************************************************************************************************/
	...
	IF ( OBJECT_ID('tempdb..##Email_HTML3') IS NOT NULL )
		...
		SELECT	TOP 5
			...
			[Growth]	AS [Growth]
		INTO ##Email_HTML3
		FROM  [dbo].[dtx_tb_CheckList_Data_Files]
	...
	***********************************************************************************************************************************/
	...
	SELECT	TOP 5
			...
			[Growth]			AS [Growth]
	INTO ##Email_HTML4
	FROM  [dbo].[dtx_tb_CheckList_Log_Files]
	ORDER BY [Total_Reserved] DESC,[Total_Used] DESC
	...
	IF ( OBJECT_ID('tempdb..##Email_HTML6') IS NOT NULL )
		...
		FROM (
						SELECT	TOP 10
								...
								ISNULL([Growth_30_days], 0) AS [Growth_30_days],
								ISNULL([Growth_60_days], 0) AS [Growth_60_days]
						FROM [dbo].[dtx_tb_CheckList_Table_Growth_Email]
						WHERE [Nm_Server] IS NOT NULL		
	...
	***********************************************************************************************************************************/
		...
		INTO ##Email_HTML7
		from [dbo].[dtx_tb_CheckList_File_Writes]		
	...
	***********************************************************************************************************************************/
		...
		INTO ##Email_HTML8
		from [dbo].[dtx_tb_CheckList_File_Reads]
		...
		***********************************************************************************************************************************/
		...
		INTO ##Email_HTML9
		from [dbo].[dtx_tb_CheckList_Database_Auto_Growth]
	...
	***********************************************************************************************************************************/	
		...
		INTO ##Email_HTML10
		FROM [dbo].[dtx_tb_CheckList_Database_Without_Backup]	
	...
	***********************************************************************************************************************************/
		...
		INTO ##Email_HTML11
		FROM [dbo].[dtx_tb_CheckList_Backup_Executed]
	...
	***********************************************************************************************************************************/ 	
		...
		INTO ##Email_HTML12				
		FROM [dbo].[dtx_tb_CheckList_Queries_Running]		
	...
	***********************************************************************************************************************************/ 
		...
		INTO ##Email_HTML13
		FROM [dbo].[dtx_tb_CheckList_Jobs_Running]	
	...
	***********************************************************************************************************************************/ 
		...
		INTO ##Email_HTML14
		FROM [dbo].[dtx_tb_CheckList_Changed_Jobs]		
	...
	***********************************************************************************************************************************/
		...
		INTO ##Email_HTML15
		FROM [dbo].[dtx_tb_CheckList_Jobs_Failed]	
	...
	***********************************************************************************************************************************/ 
		...
		INTO ##Email_HTML16
		FROM [dbo].[dtx_tb_CheckList_Slow_Jobs]			
	...
	***********************************************************************************************************************************/ 
		IF ( OBJECT_ID('tempdb..##Email_HTML18') IS NOT NULL )
			...
			INTO ##Email_HTML18
			FROM [dbo].[dtx_tb_CheckList_Profile_Queries_LastDays]
	...
	***********************************************************************************************************************************/
		...
		SELECT	[Hour],
						...
						[Page Splits/sec]
		INTO ##Email_HTML19
		FROM [dbo].[dtx_tb_CheckList_Counters_Email] AS C		
	...
	***********************************************************************************************************************************/ 
		...
		INTO ##Email_HTML20
		FROM [dbo].[dtx_tb_CheckList_Opened_Connections_Email]							
	...
	***********************************************************************************************************************************/
		...
		INTO ##Email_HTML22
		FROM [dbo].[dtx_tb_CheckList_Waits_Stats]		
	...
	***********************************************************************************************************************************/
		...
		INTO ##Email_HTML23
		FROM [dbo].[dtx_tb_CheckList_Alert_Sem_Clear]				
		...
		***********************************************************************************************************************************/
		...
		SELECT	TOP 50
						...
						ISNULL([Run_Duration], '-') AS [Open Time]
		INTO ##Email_HTML24
		FROM [dbo].[dtx_tb_CheckList_Alert]						
	...
	***********************************************************************************************************************************/
		...
		INTO ##Email_HTML25
		FROM [dbo].[dtx_tb_CheckList_SQLServer_LoginFailed_Email]
	...
	***********************************************************************************************************************************/
		...
		SELECT	TOP 100
						...
						[Text] 
		INTO ##Email_HTML26
		FROM [dbo].[dtx_tb_CheckList_SQLServer_ErrorLog]	  					
...
IF ( OBJECT_ID('[dbo].[dtx_sp_Load_CheckList_Information]') IS NOT NULL ) 
	DROP PROCEDURE [dbo].dtx_sp_Load_CheckList_Information
GO

	CREATE PROCEDURE dtx_sp_Load_CheckList_Information
	AS
	BEGIN	
		...
		SELECT Nm_Procedure
		From dtx_tb_CheckList_Parameter
...
GO
GO
IF EXISTS (SELECT job_id FROM msdb.dbo.sysjobs_view WHERE name = N'DataEX - CheckList SQL Server Instance')
EXEC msdb.dbo.sp_delete_job @job_name=N'DataEX - CheckList SQL Server Instance', @delete_unused_schedule=1
GO
GO
...
BEGIN TRANSACTION
	...
	EXEC @ReturnCode = [msdb].[dbo].[sp_add_job]
			@job_name = N'DataEX - CheckList SQL Server Instance', 
			@enabled = 1, 
			...
			@notify_email_operator_name=N'DTX_DBA_Team_Operator',
			@job_id = @jobId OUTPUT
	...
	EXEC @ReturnCode = [msdb].[dbo].[sp_add_jobstep]
			@job_id = @jobId,
			@step_name = N'DataEX - Load Table CheckList',
			@step_id = 1,
			...
			@subsystem = N'TSQL',
			@command = N'			
				exec dtx_sp_Load_CheckList_Information',
	...
	EXEC @ReturnCode = [msdb].[dbo].[sp_add_jobstep]
			@job_id = @jobId, 
			@step_name = N'DataEX - Send CheckList Mail', 
			@step_id = 2, 
			@cmdexec_success_code = 0,
			@on_success_action = 1,
			@on_success_step_id = 0, 
			...
			@os_run_priority = 0, 
			@subsystem = N'TSQL', 
			@command = N'EXEC[dbo].[dtx_sp_Send_Mail_CheckList_DBA]', 
			@database_name = N'DBADataEX', 
			@flags = 0
...
--------------------------------------------------------------------------------------------------------------------------------
-- JOB: DataEX - Load SQL Server Counters
--------------------------------------------------------------------------------------------------------------------------------

IF EXISTS (SELECT job_id 
            FROM msdb.dbo.sysjobs_view 
            WHERE name = N'DataEX - Load SQL Server Counters')
EXEC msdb.dbo.sp_delete_job @job_name=N'DataEX - Load SQL Server Counters'  , @delete_unused_schedule=1
...
BEGIN TRANSACTION
	...
	DECLARE @jobId BINARY(16)
	EXEC @ReturnCode =  msdb.dbo.sp_add_job 
			@job_name = N'DataEX - Load SQL Server Counters', 
			@enabled = 1, 
			@notify_level_eventlog = 0, 
	...
	EXEC @ReturnCode = msdb.dbo.sp_add_jobstep 
			@job_id = @jobId, 
			@step_name = N'DataEX - Load SQL Server Counters', 
			@step_id = 1, 
			@cmdexec_success_code = 0, 
			@on_success_action = 1, 
			@on_success_step_id = 0, 
			...
			@os_run_priority = 0,
			@subsystem = N'TSQL', 
			@command = N'exec dtx_sp_Load_SQL_Counter', 
			@database_name = N'DBADataEX', 
			@flags=0
...
--------------------------------------------------------------------------------------------------------------------------------
-- JOB: DataEX - Load Table Size
--------------------------------------------------------------------------------------------------------------------------------
-- Se o job já existe, exclui para criar novamente.
IF EXISTS (	SELECT job_id 
            FROM msdb.dbo.sysjobs_view 
            WHERE name = N'DataEX - Load Table Size')
	EXEC msdb.dbo.sp_delete_job @job_name = N'DataEX - Load Table Size', @delete_unused_schedule = 1
...
BEGIN TRANSACTION
	...
	DECLARE @jobId BINARY(16)
	EXEC @ReturnCode =  msdb.dbo.sp_add_job 
			@job_name = N'DataEX - Load Table Size', 
			@enabled = 1, 
			@notify_level_eventlog = 0, 
			@notify_level_email = 2, 
			@notify_level_netsend = 0, 
	...
	EXEC @ReturnCode = msdb.dbo.sp_add_jobstep
			@job_id = @jobId, 
			@step_name = N'DataEX - Load Table Size', 
			@step_id = 1, 
			@cmdexec_success_code = 0, 
			@on_success_action = 1, 
			@on_success_step_id = 0, 
			...
			@os_run_priority = 0, 
			@subsystem = N'TSQL', 
			@command = N'exec dtx_sp_Load_Table_Size', 
			@database_name = N'DBADataEX', 
			@flags = 0
...
--------------------------------------------------------------------------------------------------------------------------------
-- JOB: DataEX - Load SQL Server Files Performance
--------------------------------------------------------------------------------------------------------------------------------
...
IF EXISTS (SELECT job_id 
            FROM msdb.dbo.sysjobs_view 
            WHERE name = N'DataEX - Load SQL Server Files Performance')
EXEC msdb.dbo.sp_delete_job @job_name=N'DataEX - Load SQL Server Files Performance'  , @delete_unused_schedule=1
...
DECLARE @jobId BINARY(16)
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DataEX - Load SQL Server Files Performance', 
		@enabled=1, 
		@notify_level_eventlog=0, 
		@notify_level_email=2, 
		@notify_level_netsend=0, 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'DataEX - Load SQL Server Files Performance', 
		@step_id=1, 
		@cmdexec_success_code=0, 
		@on_success_action=1, 
		@on_success_step_id=0, 
		...
		@command=N'EXEC [dbo].[dtx_sp_Load_File_Utilization]', 
		@database_name=N'DBADataEX', 
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_update_job @job_id = @jobId, @start_step_id = 1
...
IF EXISTS (SELECT job_id 
            FROM msdb.dbo.sysjobs_view 
            WHERE name = N'DataEX - Load Wait Stats')
EXEC msdb.dbo.sp_delete_job @job_name=N'DataEX - Load Wait Stats'  , @delete_unused_schedule=1
...
BEGIN TRANSACTION
	...
	DECLARE @jobId BINARY(16)
	EXEC @ReturnCode =  msdb.dbo.sp_add_job 
			@job_name = N'DataEX - Load Wait Stats', 
			@enabled = 1, 
			@notify_level_eventlog = 0, 
			@notify_level_email = 0, 
			@notify_level_netsend = 0, 
	...
	EXEC @ReturnCode = msdb.dbo.sp_add_jobstep 
			@job_id = @jobId, 
			@step_name = N'DataEX - Load Wait Stats', 
			@step_id = 1, 
			@cmdexec_success_code = 0, 
			@on_success_action = 1, 
			@on_success_step_id = 0, 
			...
			@os_run_priority = 0, 
			@subsystem = N'TSQL', 
			@command = N'exec dtx_sp_Load_Waits_Stats_History', 
			@database_name = N'DBADataEX', 
			@flags = 0
