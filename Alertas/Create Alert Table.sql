...
VALUES	('Version DB CheckList ',				'2.0',@Fl_Language,									0,1,		NULL,	NULL,			@Ds_Profile_Email,	@Ds_Email,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
		...
		('Trace Creation',			'dtx_sp_Trace_Creation',@Fl_Language,							0,1,		3,		'Seconds',		@Ds_Profile_Email,	@Ds_Email,'This is not an Alert','','Não é um Alerta. É para a criação do profile de 3 segundos.','',NULL,NULL,NULL,NULL),
		...
		('Page Corruption',				'dtx_sp_Alert_Page_Corruption',@Fl_Language,				0,1,		NULL,	NULL,			@Ds_Profile_Email,	@Ds_Email,'ALERT: There is a corrupted page on a database on Server: ','','ALERTA: Existe uma Página Corrompida no BD no Servidor: ','','Corrupted Pages','','Páginas Corrompidas',''),
		...
		('Job Failed',						'dtx_sp_Alert_Job_Failed',@Fl_Language,						0,1,		24,		'Hours',		@Ds_Profile_Email,	@Ds_Email,'ALERT: Jobs failed in the last ###1 Hours on Server: ','','ALERTA: Jobs que Falharam nas últimas ###1 Horas no Servidor: ','','TOP 50 - Failed Jobs',NULL,'TOP 50 - Jobs que Falharam',NULL),
		...
		('Slow Disk',					'dtx_sp_Alert_Slow_Disk',@Fl_Language,					0,1,		24,	'Hour',			@Ds_Profile_Email,	@Ds_Email,'ALERT: There is a slow disk message on the Last Day on Server: ','','ALERTA: Existe uma mensagem de lentidão de Disco no Dia Anterior no Servidor: ','','Yesterday Slow Disk Access ',NULL,'Lentidão de Acesso a Disco no Dia Anterior',NULL),
		('Slow Disk Every Hour',		'dtx_sp_Alert_Slow_Disk',@Fl_Language,					0,0,		1,	'Hour',			@Ds_Profile_Email,	@Ds_Email,'ALERT: There is a slow disk message in the Last Hour on Server: ','','ALERTA: Existe uma mensagem de lentidão de Disco na última Hora no Servidor: ','','Slow Disk Access ',NULL,'Lentidão de Acesso a Disco',NULL),
		('Process Executing',			'dtx_sp_Send_Mail_Executing_Process',@Fl_Language,		0,1,		NULL,	NULL,			@Ds_Profile_Email,	@Ds_Email,'INFO: SQL Process running Now on Server: ','','INFO: Processos executando no Banco de Dados agora no servidor: ','','TOP 50 - Process Executing on Database',NULL,'Processos em Execução no Banco de Dados',NULL),
		...
		('SQL Server Configuration',			'dtx_sp_SQLServer_Configuration',@Fl_Language,		0,1,		NULL,	NULL,			@Ds_Profile_Email,	@Ds_Email,'INFO: Database Information on Server: ','','INFO: Informações do Banco de Dados no Servidor: ','',NULL,NULL,NULL,NULL),
		...
		('Rebuild Failed',			'dtx_sp_Alert_Rebuild_Failed',@Fl_Language,						0,1,		8,		'Hours',		@Ds_Profile_Email,	@Ds_Email,'ALERT: The Rebuild Job failed because Lock Timeout on Server: ','','ALERTA: O Job de Rebuild falhou por causa de Lock no Servidor : ','','Last Lock Registered',NULL,'Último Lock Registrado',NULL),
		('DeadLock',			'dtx_sp_Alert_DeadLocks',@Fl_Language,						0,0,		24,		'Hours',		@Ds_Profile_Email,	@Ds_Email,'ALERT: We had ###2 DeadLocks in the last ###1 Hours on Server: ','','ALERTA: Aconteceram ###2 DeadLocks as ultimas ###1 Horas no Servidor : ','','DeadLocks Occurrence',NULL,'Ocorrências de DeadLocks',NULL),
		('Database Growth',			'dtx_sp_Alert_Database_Growth',@Fl_Language,						0,1,		20,		'GB',		@Ds_Profile_Email,	@Ds_Email,'ALERT: We had a large Database Growth in the Last 24 Hours on Server : ','','ALERTA: Tivemos um crescimento grande de base nas últimas 24 horas no Servidor : ','','Database Growth',NULL,'Crescimento da Base',NULL),
	    ...
	    ('Failover Cluster Active Node',  	 'dtx_sp_Alert_Cluster_Active_Node',    @Fl_Language,    0,   0,    NULL,    NULL, @Ds_Profile_Email,	@Ds_Email,'ALERT: The Failover Cluster Active Node has Changed','',	'ALERTA: O nó ativo do Cluster mudou',      '', 	   'Failover Cluster Nodes Now', '',  'Failover Cluster Nodes agora',      ''),
